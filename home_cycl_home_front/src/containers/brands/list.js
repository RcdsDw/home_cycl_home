...
export default function BrandsModels() {
    ...
    const columnsBrands = [
        ...
        },
        {
            ...
            align: 'right',
            render: (_, column) => (
                <Button type="primary" danger onClick={() => showModal("brand", parseID(column))}>
                    <DeleteOutlined />
                </Button>
            ),
        },
    ...
    const columnsModels = [
        ...
        },
        {
            ...
            align: 'right',
            render: (_, column) => (
                <Button type="primary" danger onClick={() => showModal("model", parseID(column))}>
                    <DeleteOutlined />
                </Button>
            ),
        },
        ...
        <div style={styles.container}>
            ...
            <Card style={styles.card}>
                <div style={styles.title}>
                    ...
                    <CreateModelModal selectedBrand={selectedBrand} setSelectedBrand={setSelectedBrand} fetchBrands={fetchBrands} />
                </div>
                <Table
